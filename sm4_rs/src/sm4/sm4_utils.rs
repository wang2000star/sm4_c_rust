...
static SM4_SBOX: [u8; 256] = [  0xd6, 0x90, 0xe9, 0xfe, 0xcc, 0xe1, 0x3d, 0xb7, 0x16, 0xb6, 0x14, 0xc2, 0x28, 0xfb, 0x2c, 0x05,
                                0x2b, 0x67, 0x9a, 0x76, 0x2a, 0xbe, 0x04, 0xc3, 0xaa, 0x44, 0x13, 0x26, 0x49, 0x86, 0x06, 0x99,
                                0x9c, 0x42, 0x50, 0xf4, 0x91, 0xef, 0x98, 0x7a, 0x33, 0x54, 0x0b, 0x43, 0xed, 0xcf, 0xac, 0x62,
                                0xe4, 0xb3, 0x1c, 0xa9, 0xc9, 0x08, 0xe8, 0x95, 0x80, 0xdf, 0x94, 0xfa, 0x75, 0x8f, 0x3f, 0xa6,
                                0x47, 0x07, 0xa7, 0xfc, 0xf3, 0x73, 0x17, 0xba, 0x83, 0x59, 0x3c, 0x19, 0xe6, 0x85, 0x4f, 0xa8,
...
//     // let upper_nibble = o >> 4;
//     // let lower_nibble = o % 16;
//     // SM4_SBOX[(upper_nibble * 16 + lower_nibble) as usize]
//     SM4_SBOX[o as usize]
// }
//字节替换层，调用substitute
// fn sub_word(x : u32) -> u32{
//     let bytes : Vec<u8> = (0..4).map(|i| (x >> (8 * (3 - i)) % 256) as u8).collect();
//     let bytes_subs : Vec<u8> = bytes.iter().map(|o|SM4_SBOX[*o as usize]).collect();
...
// filepath: /home/wfz/sm4_pro/sm4_rs/src/sm4/sm4_utils.rs
...
pub fn sm4key_expansion(mode : bool, sm4_key : &[u8;16]) -> [u32;32]{
...
/*  sm4拓展秘钥是长度为32的向量，向量元素长度为32比特，相当于128字节
    ...
    轮数是32轮
*/
pub fn sm4_enc_dec(enc_key : &[u32;32], plaintext : &[u8; 16]) -> [u8;16]{
